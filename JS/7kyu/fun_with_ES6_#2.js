/**
 * Created on Thu Oct 26 22:11:53 2017
 * @author: Dmitry White
 */

 /**
  * TODO: Define the following classes that inherit from Animal.
  * I. Shark
  *    The constructor function for Shark should accept 3 arguments in total
  *    in the following order: name, age, status. All sharks should have
  *    a leg count of 0 (since they obviously do not have any legs) and
  *    should have a species of "shark".
  * II. Cat
  ...
  *    name, age, status, master. master is the name of the dog's master
  *    which will be a string. Furthermore, dogs should have 4 legs and
  *    a species of "dog".
  ...
  *    (of course not the literal string but replace the
